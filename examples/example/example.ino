const uint8_t sclk =  14; //SCLK
const uint8_t mosi =  13; //MOSI (Master Output Slave Input)
const uint8_t cs =  15; // (Master Input Slave Output)
const uint8_t rst = 4;
const uint8_t dc =  16; //OLED DC(Data/Command)
